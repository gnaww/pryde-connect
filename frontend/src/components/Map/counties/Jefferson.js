...
export default class Jefferson extends React.Component {
    render() {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 198 170" onClick={this.props.onClick}>
                <defs>
                    <style>{`\
                            .cls-1{\
